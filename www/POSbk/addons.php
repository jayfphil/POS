                                                                    ...
                                                                    <td>
                                                                        <div class="toggle-select-act fm-cmp-mg">
                                                                            <div class="nk-toggle-switch" data-ts-color="red">
                                                                                <input id="ts_delete_<?php echo $row_addons['id']; ?>" class="tick_delete" data-prompt="success" type="checkbox" hidden="hidden" data-type="addons-tb" data-id="<?php echo $row_addons['id']; ?>" <?php echo $checked_active; ?> value="<?php echo $row_addons['at_deleted']; ?>">
