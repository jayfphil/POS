    ...
    <div class="container-fluid">
      ...
      <form action="pos.php">
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-3 col-md-2 col-sm-2 col-xs-12">
            <input type="text" class="form-control" id="total_income" disabled placeholder="PHP" value="<?php echo ($result_dailytotal['DailyTotal']) ? number_format($result_dailytotal['DailyTotal'], 2):""; ?>">
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-3 col-md-2 col-sm-2 col-xs-12">
            <input type="number" class="form-control" id="total_expense" placeholder="PHP">
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-3 col-md-2 col-sm-2 col-xs-12">
            <input type="text" class="form-control" id="net_income" disabled placeholder="PHP">
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-3 col-md-2 col-sm-2 col-xs-12 short-div">
            <input type="number" class="form-control" id="coh" placeholder="PHP">
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-3 col-md-2 col-sm-2 col-xs-12 short-div">
            <input type="text" class="form-control" id="grand_total" disabled placeholder="PHP">
          </div>
