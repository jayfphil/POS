        ...
        <?php
          for ($addyear = 1; $addyear <= $fixmonth; $addyear++) {
              if(($fixyear+$addyear)==$y) {
                  ...
                  echo "<th><a href='daily_sales_monitoring.php?pickyear=".($fixyear+$addyear)."&pickmonth=".@$_REQUEST['pickmonth']."'>".($fixyear+$addyear)."</a></th>";
              }
          }
        ?>
        </tr>
        ...
        <?php
          for ($months = 1; $months <= $fixmonth; $months++) {
              ...
              if($months==$m) {
                  ...
                  echo "<th><a href='daily_sales_monitoring.php?pickyear=".@$_REQUEST['pickyear']."&pickmonth=".$months."'>".date("F", mktime(0, 0, 0, $months))."</a></th>";
              }
          }
        ?>
        </tr>
