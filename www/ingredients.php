                                                                ...
                                                                <td>
                                                                    <div class="toggle-select-act fm-cmp-mg">
                                                                        <div class="nk-toggle-switch" data-ts-color="red">
                                                                            <input id="ts<?php echo $row_ingredients['id']; ?>" class="tick_delete" data-prompt="success" type="checkbox" hidden="hidden" data-type="ingredients" data-id="<?php echo $row_ingredients['id']; ?>" value="1" <?php echo $checked; ?>>
